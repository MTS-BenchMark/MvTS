...
class StemGNN(nn.Module):
    def __init__(self, config, data_feature):
        ...
        self.train_normalize_statistic = self.data_feature['train_normalize_statistic']
        self.valid_normalize_statistic = self.data_feature['valid_normalize_statistic']
        self.test_normalize_statistic = self.data_feature['test_normalize_statistic']
