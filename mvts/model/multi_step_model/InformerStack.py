...
class InformerStack(nn.Module):
    def __init__(self, config, data_feature):
        ...
        super().__init__()
        self.config = config
        self.enc_in = self.config.get('enc_in')
        self.dec_in = self.config.get('dec_in')
        self.c_out = self.config.get('c_out')
        ...
        self.n_heads = self.config.get('n_heads')
        self.e_layers = self.config.get('s_layers')
        self.e_layers = [int(s_l) for s_l in self.e_layers.replace(' ', '').split(',')]
        self.d_layers = self.config.get('d_layers')
        self.d_ff = self.config.get('d_ff')
        self.attn = self.config.get('attn')
        ...
        self.distil = self.config.get('distil')
        self.mix = self.config.get('mix')
